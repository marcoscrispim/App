...
class ArtigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artigo" do
    assert_difference("Artigo.count") do
      post artigos_url, params: { artigo: { Descrição: @artigo.Descrição, Titulo: @artigo.Titulo } }
    end
  ...
  test "should update artigo" do
    patch artigo_url(@artigo), params: { artigo: { Descrição: @artigo.Descrição, Titulo: @artigo.Titulo } }
